...
namespace PRTFile
{
    ...
    public:
        ...
        typedef boost::variant< toRefType<AttributeContainer_INT8T>::type,
    ...
    protected:
        ...
        class AttributeRefDataTypeIDVisitor: public boost::static_visitor<INT32>
        {
        ...
        class AttributeRefComponentCountVisitor: public boost::static_visitor<INT32>
        {
        ...
        class BufferTransferVisitor: public boost::static_visitor<>
        {
    ...
    public:
        ...
        {
            return boost::get< typename toRefType< AttributeContainerT<TypeT> >::type >( attributeMap[ name ] );
        };
        ...
        void save( const std::string &filePath )
        {
            ...
            for( AttributeMapType::const_iterator it = attributeMap.begin(); it != attributeMap.end(); ++it )
            {
                ...
                boost::apply_visitor( bufferTransferVisitor, it->second );
            }
            ...
            if( compress2( compressedAttributeBuffer, &attributeBufferCompressedSize, reinterpret_cast<Bytef*>( attributeBufferData ), attributeBufferSize, 6 ) == Z_OK )
            {
                ...
                if ( filestream.good() )
                {
                    ...
                    for( AttributeMapType::const_iterator it = attributeMap.begin(); it != attributeMap.end(); ++it )
                    {
                        ...
                        channelDefinition.dataType  = boost::apply_visitor( typeIDVisitor, it->second );
                        channelDefinition.arity     = boost::apply_visitor( componentCountVisitor, it->second );
